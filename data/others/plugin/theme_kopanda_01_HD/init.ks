...
; メッセージウィンドウの設定
[position layer="message0" width="1280" height="400" top="510" left="0"]
[position layer="message0" page="fore" frame="../others/plugin/theme_kopanda_01_HD/image/frame_message.png" margint="40" marginl="60" marginr="80" marginb="40" opacity="&mp.frame_opacity"]

; 名前枠の設定
[ptext name="chara_name_area" layer="message0" color="&mp.name_color" size="24" bold="bold" x="80" y="520" width="400"]
